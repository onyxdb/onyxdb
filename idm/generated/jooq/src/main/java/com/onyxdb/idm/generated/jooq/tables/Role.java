...
import com.onyxdb.idm.generated.jooq.tables.Permission.PermissionPath;
...
public class Role extends TableImpl<RoleRecord> {
     ...
     */
    public final TableField<RoleRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>public.role.updated_at</code>.
     */
    public final TableField<RoleRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    public AccountResourceRolePath accountResourceRole() {
        if (_accountResourceRole == null)
            _accountResourceRole = new AccountResourceRolePath(this, null, Keys.ACCOUNT_RESOURCE_ROLE__ACCOUNT_RESOURCE_ROLE_ROLE_ID_FKEY.getInverseKey());
    ...
    public AccountRolePath accountRole() {
        if (_accountRole == null)
            _accountRole = new AccountRolePath(this, null, Keys.ACCOUNT_ROLE__ACCOUNT_ROLE_ROLE_ID_FKEY.getInverseKey());
    ...
    public BusinessRoleRolePath businessRoleRole() {
        if (_businessRoleRole == null)
            _businessRoleRole = new BusinessRoleRolePath(this, null, Keys.BUSINESS_ROLE_ROLE__BUSINESS_ROLE_ROLE_ROLE_ID_FKEY.getInverseKey());
    ...
    public BusinessRolePath businessRole() {
        return businessRoleRole().businessRole();
    }
