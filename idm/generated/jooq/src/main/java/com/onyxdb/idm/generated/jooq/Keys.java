...
public class Keys {
    ...
    public static final UniqueKey<AccountResourceRoleTableRecord> ACCOUNT_RESOURCE_ROLE_TABLE_PKEY = Internal.createUniqueKey(AccountResourceRoleTable.ACCOUNT_RESOURCE_ROLE_TABLE, DSL.name("account_resource_role_table_pkey"), new TableField[] { AccountResourceRoleTable.ACCOUNT_RESOURCE_ROLE_TABLE.ACCOUNT_ID, AccountResourceRoleTable.ACCOUNT_RESOURCE_ROLE_TABLE.RESOURCE_ID, AccountResourceRoleTable.ACCOUNT_RESOURCE_ROLE_TABLE.ROLE_ID }, true);
    ...
    public static final ForeignKey<AccountResourceRoleTableRecord, AccountTableRecord> ACCOUNT_RESOURCE_ROLE_TABLE__ACCOUNT_RESOURCE_ROLE_TABLE_ACCOUNT_ID_FKEY = Internal.createForeignKey(AccountResourceRoleTable.ACCOUNT_RESOURCE_ROLE_TABLE, DSL.name("account_resource_role_table_account_id_fkey"), new TableField[] { AccountResourceRoleTable.ACCOUNT_RESOURCE_ROLE_TABLE.ACCOUNT_ID }, Keys.ACCOUNT_TABLE_PKEY, new TableField[] { AccountTable.ACCOUNT_TABLE.ID }, true);
    public static final ForeignKey<AccountResourceRoleTableRecord, ResourceTableRecord> ACCOUNT_RESOURCE_ROLE_TABLE__ACCOUNT_RESOURCE_ROLE_TABLE_RESOURCE_ID_FKEY = Internal.createForeignKey(AccountResourceRoleTable.ACCOUNT_RESOURCE_ROLE_TABLE, DSL.name("account_resource_role_table_resource_id_fkey"), new TableField[] { AccountResourceRoleTable.ACCOUNT_RESOURCE_ROLE_TABLE.RESOURCE_ID }, Keys.RESOURCE_TABLE_PKEY, new TableField[] { ResourceTable.RESOURCE_TABLE.ID }, true);
    public static final ForeignKey<AccountResourceRoleTableRecord, RoleTableRecord> ACCOUNT_RESOURCE_ROLE_TABLE__ACCOUNT_RESOURCE_ROLE_TABLE_ROLE_ID_FKEY = Internal.createForeignKey(AccountResourceRoleTable.ACCOUNT_RESOURCE_ROLE_TABLE, DSL.name("account_resource_role_table_role_id_fkey"), new TableField[] { AccountResourceRoleTable.ACCOUNT_RESOURCE_ROLE_TABLE.ROLE_ID }, Keys.ROLE_TABLE_PKEY, new TableField[] { RoleTable.ROLE_TABLE.ID }, true);
