...
public class Keys {
    ...
    public static final UniqueKey<AccountTableRecord> ACCOUNT_TABLE_LOGIN_KEY = Internal.createUniqueKey(AccountTable.ACCOUNT_TABLE, DSL.name("account_table_login_key"), new TableField[] { AccountTable.ACCOUNT_TABLE.LOGIN }, true);
    ...
    public static final ForeignKey<ProjectTableRecord, ProjectTableRecord> PROJECT_TABLE__PROJECT_TABLE_PARENT_ID_FKEY = Internal.createForeignKey(ProjectTable.PROJECT_TABLE, DSL.name("project_table_parent_id_fkey"), new TableField[] { ProjectTable.PROJECT_TABLE.PARENT_ID }, Keys.PROJECT_TABLE_PKEY, new TableField[] { ProjectTable.PROJECT_TABLE.ID }, true);
    ...
    public static final ForeignKey<RoleTableRecord, ProjectTableRecord> ROLE_TABLE__ROLE_TABLE_PROJECT_ID_FKEY = Internal.createForeignKey(RoleTable.ROLE_TABLE, DSL.name("role_table_project_id_fkey"), new TableField[] { RoleTable.ROLE_TABLE.PROJECT_ID }, Keys.PROJECT_TABLE_PKEY, new TableField[] { ProjectTable.PROJECT_TABLE.ID }, true);
}
