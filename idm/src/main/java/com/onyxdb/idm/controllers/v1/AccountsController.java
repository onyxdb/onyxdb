...
public class AccountsController implements AccountsApi {
    ...
    @Override
    public ResponseEntity<AccountDTO> createAccount(@Valid AccountDTO accountDTO) {
    ...
    @Override
    public ResponseEntity<AccountDTO> updateAccount(UUID accountId, @Valid AccountDTO accountDTO) {
        Account account = Account.fromDTO(accountDTO);
