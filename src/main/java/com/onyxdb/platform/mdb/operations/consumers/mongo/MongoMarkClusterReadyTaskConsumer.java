...
@Component
public class MongoMarkClusterReadyTaskConsumer extends ClusterTaskConsumer {
    private final ClusterRepository clusterRepository;

    public MongoMarkClusterReadyTaskConsumer(
    ...
    public TaskType getTaskType() {
        return TaskType.MONGO_MARK_CLUSTER_READY;
    }
