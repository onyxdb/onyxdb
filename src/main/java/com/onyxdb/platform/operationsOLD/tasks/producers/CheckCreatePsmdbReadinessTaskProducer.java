...
//
//@Service
//public class CheckCreatePsmdbReadinessTaskProducer extends CreateMongoClusterTaskProducer {
//    protected CheckCreatePsmdbReadinessTaskProducer(ObjectMapper objectMapper) {
//        super(objectMapper);
//    }
//
//    @Override
...
//                operation.id(),
//                List.of(Objects.requireNonNull(taskChain.createPsmdbTaskId))
//        ));
//
