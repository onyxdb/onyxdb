...
//
//@Service
//public class CreateMongoExporterServiceScrapeTaskProducer extends TaskProducer<CreateMongoClusterTaskChain> {
//    @Override
...
//                operation.id(),
//                List.of(Objects.requireNonNull(taskChain.createMongoExporterServiceTaskId))
//        ));
//
//        taskChain.createMongoExporterServiceScrapeTaskId = taskId;
