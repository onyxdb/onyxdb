...
import com.onyxdb.mdb.core.hardwarePresets.HardwarePreset;
import com.onyxdb.mdb.core.hardwarePresets.HardwarePresetConverter;
...
public class V1HardwarePresetController implements V1HardwarePresetsApi {
    ...
    public ResponseEntity<V1HardwarePresetResponse> getHardwarePreset(String hardwarePresetId) {
        HardwarePreset hardwarePreset = hardwarePresetService.getOrThrow(hardwarePresetId);
